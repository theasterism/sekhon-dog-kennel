/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: be0e1a4d30d12b61e36eba71f2f62980)
// Runtime types generated with workerd@1.20251213.0 2025-11-17 enable_request_signal,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NODE_ENV: "production";
		BUCKET: R2Bucket;
		DB: D1Database;
		AUTH_RATELIMIT: RateLimit;
		IMAGE: ImagesBinding;
	}
}

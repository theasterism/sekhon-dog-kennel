...
INSERT INTO `__new_dog`("id", "name", "breed", "date_of_birth", "gender", "size", "color", "weight", "description", "status", "price", "microchipped", "vaccinations", "dewormings", "vet_checked", "created_at", "updated_at") SELECT "id", "name", "breed", "date_of_birth", "gender", "size", "color", "weight", "description", "status", "price", "microchipped", "vaccinations", "dewormings", "vet_checked", "created_at", "updated_at" FROM `dog`;--> statement-breakpoint
